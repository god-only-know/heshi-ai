...
export function getFriends() {
  return request.post<Clochat.FriendItem[]>('/friends/list')
}

export function getFriendById(friendId: string) {
  return request.post('/friends/detail', { friendId })
}

export function addFriend(data: Api.Clochat.AddFriendParams) {
  return request.post('/friends/create', data)
}

export function updateFriend(data: Clochat.FriendItem) {
  return request.post('/friends/update', data)
}
...
export function blockFriend(friendId: string) {
  return request.post('/friends/block', { friendId })
}

// 新增：取消拉黑好友
export function unblockFriend(friendId: string) {
  return request.post('/friends/unblock', { friendId })
}
...
export function getChatDetail(chat_id: string) {
  return request.post<Api.Clochat.getChatDetailResult>('/chat/detail', { chat_id })
}

export function getChatByFriendId(friendId: string) {
  return request.post('/chat/friend', { friendId })
}
...
export function deleteChat(chatId: string) {
  return request.post('/chat/delete', { chatId })
}

// 聊天记录相关API
export function markMessagesAsRead(message_ids: string[]) {
  return request.post('/chat-records/mark-as-read', { message_ids })
}

export function getUnreadMessages(chatId: string) {
  return request.post('/chat-records/unread', { chatId })
}

export function getChatRecords(chatId: string) {
  return request.post('/chat-records/list', { chatId })
}
